...
public class CrearHtml {
    ...
    public static void ListaImagenes(ArrayList<Pensum> listaPensum){
        
        String Contenido;
        Contenido = "<html>"
                + "<body>"
                + "<h1 align='center'>PENSUMS</h1></br>"
                + "<table cellpadding='10' border = '1' align='center'>"
                + "<tr>"
                + "<td><strong>No."
                + "</strong></td>"
        ...
        for (Pensum t : listaPensum) {
            ...
            try {
                tempotk = "<tr>"
                        + "<td><strong>" + Integer.toString(x)
                        + "</strong></td>"
                        + "<td>" + "<img src=\"" + miDir.getCanonicalPath() +"\\" + t.getNombre() + ".png" +"\">"
                        + "</td>"
                        + "</tr>";
        ...
        //creando archivo html/
        File file = new File("ReportePensum.html");
